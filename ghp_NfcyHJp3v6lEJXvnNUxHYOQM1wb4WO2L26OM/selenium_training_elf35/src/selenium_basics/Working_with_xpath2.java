...
public class Working_with_xpath2 {
	...
	public static void main(String[] args) {
		...
		System.setProperty("webdriver.chrome.driver","C:\\Users\\admin\\eclipse-workspace\\selenium_training_elf35\\drivers\\chromedriver.exe");
		 ...
		 driver.findElement(By.xpath("//input[1]")).sendKeys("Nikhil");
		 driver.findElement(By.xpath("//input[2]")).sendKeys("Niki");
		 driver.findElement(By.xpath("//div[2]/input[1]")).sendKeys("TESTYANTRA");
		 driver.findElement(By.xpath("//div[2]/input[2]")).sendKeys("BANGLORE");
