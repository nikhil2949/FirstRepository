...
public class Registration_for_demoweb_shop extends Base_Test {
	@Test
	...
	public void registration_for_demoweb_shop() {
	    ...
	    Reporter.log("register is successful");
